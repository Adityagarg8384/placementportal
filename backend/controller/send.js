...
const sendmessage = async (req, res) => {
    try {
        ...
        console.log("Sender params are ", req.body, req.params);
...
const receivemessage = async (req, res) => {
    try {
        console.log("receiver params are ", req.params);
        const receiverid = req.params.id;
...
const sendrecuritermessage= async(req, res)=>{
    try {
        const message = req.body.message;
        const receiverid = req.params.id;
        const senderid = req.user._id;
...
module.exports = { sendmessage, receivemessage, sendrecuritermessage, receiverecruitermessage };