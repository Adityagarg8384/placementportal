...
const {getuser, getuserpost, updateuser, getspecificuser, removejobapplied} = require("./controller/getuser");
...
const {updaterecruiter, getspecificrecruiter}= require("./controller/recruiter");
